...
const ContactForm = () => {
  return (
    <div className="flex justify-center sm:items-center min-h-[70vh]">
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div className="mt-8 overflow-hidden bg-light p-10 rounded max-sm:p-0">
                <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center">
                    <div className="bg-light p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                        ...
                        <div className="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                            ...
                            <div className="ml-4 text-md tracking-wide font-semibold w-40">
                                niceperson2110@gmail.com
                            </div>
                        </div>
                    </div>

                    <form className="p-6 flex flex-col justify-center bg-light">
                        ...
                        <button type="submit" className="md:w-32 bg-[black] hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3">
                            Submit
                        </button>
                    </form>
                </div>
